        ...
        <div className="overflow-x-auto">
          {loading && students.length === 0 ? (
            ...
            <div className="p-20 text-center">
                ...
                <p className="text-sm font-black text-slate-400 uppercase tracking-[0.2em]">No students found</p>
                <p className="text-xs text-slate-400 mt-2 font-medium">Try adjusting your search or check back later.</p>
            </div>
          )}
        </div>
      </div>
