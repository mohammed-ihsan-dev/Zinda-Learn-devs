...
const InstructorSignup = () => {
  ...
  return (
    <div className="min-h-screen flex bg-white font-sans relative">
      ...
      {/* Right Panel */}
      <div className="flex-1 flex flex-col justify-center px-8 sm:px-16 py-10 lg:px-24 overflow-y-auto">
        <div className="w-full max-w-md mx-auto">
          <div className="lg:hidden mb-12">
            <span className="text-2xl font-bold text-purple-600 tracking-wide">zindalearn</span>
          </div>

          <h2 className="text-3xl font-bold text-slate-900 mb-2">Create your Instructor<br/>account</h2>
          <p className="text-slate-500 mb-8 text-sm">Share your knowledge and grow your influence.</p>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500 focus:bg-white transition-all text-sm tracking-widest placeholder:tracking-normal"
                />
                <button
                  type="button"
          ...
          <button
            ...
            disabled={loading}
            className="w-full py-3.5 bg-slate-50 border border-slate-200 hover:bg-slate-100 text-slate-700 font-bold rounded-full transition-colors flex items-center justify-center gap-3 text-sm disabled:opacity-50"
          >
          ...
          <p className="text-center text-sm text-slate-500 mt-8">
            ...
            <Link to="/instructor/login" className="font-bold text-purple-600 hover:text-purple-700">
              Sign In
            </Link>
          </p>
        </div>
